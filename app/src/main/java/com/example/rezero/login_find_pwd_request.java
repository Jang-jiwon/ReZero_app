...
public class login_find_pwd_request extends StringRequest {

    //1. 서버 URL & PHP 파일 연결

    //서버 주소로 나중에 바꾸기
    final static private String URL = "http://delightes.dothome.co.kr/login_pwd_1.php"; //URL은 바뀔 일 없으니까 고정 상수!
    private Map<String, String> map;


    //2. 생성자 (방식, URL, 성공했을 때 작업, 실패했을 때 작업) -> String Request
    public login_find_pwd_request(String username, String user_birth, String user_email, String user_phone_num, Response.Listener<String> listener) //리스너도 매개변수로
    {
