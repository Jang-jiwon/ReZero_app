...
public class login_pwd_new2_activity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.login_pwd_new_2);
        ...
        login_view_now.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v) {
                //로그인 화면으로 이동
                Intent intent = new Intent(login_pwd_new2_activity.this, login_1_activity.class);
