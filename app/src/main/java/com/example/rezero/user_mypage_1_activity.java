...

        {
            ...
            //하단바 버튼 누름효과지정 - 주석 처리 바꿔주기
            {
                ...
                boxBtn.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        Intent goDesigner = new Intent(user_mypage_1_activity.this,DesignerList.class);
                ...
                likeBtn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        // 좋아요 화면으로 이동
                        Intent intent = new Intent(user_mypage_1_activity.this, product_like.class); // product_like
                        startActivity(intent);
                    }
                });
                myBtn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        //로그인 화면으로 이동
                        Intent intent = new Intent(user_mypage_1_activity.this, user_mypage_1_activity.class);
                        startActivity(intent);
                    }
                });
            }
