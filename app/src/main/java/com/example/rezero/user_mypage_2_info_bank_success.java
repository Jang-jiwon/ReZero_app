...
public class user_mypage_2_info_bank_success extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.user_mypage_2_info_bank_success);
        ...
        login_view_now.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v) {
                //로그인 화면으로 이동
                Intent intent = new Intent(user_mypage_2_info_bank_success.this, login_1_activity.class);
