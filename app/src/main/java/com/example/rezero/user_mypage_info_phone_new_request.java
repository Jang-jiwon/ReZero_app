...
public class user_mypage_info_phone_new_request extends StringRequest {

    //1. 서버 URL & PHP 파일 연결

    //서버 주소로 나중에 바꾸기
    final static private String URL = "http://delightes.dothome.co.kr/mypage_phone_new.php"; //URL은 바뀔 일 없으니까 고정 상수!
    private Map<String, String> map;


    //2. 생성자 (방식, URL, 성공했을 때 작업, 실패했을 때 작업) -> String Request
    public user_mypage_info_phone_new_request(String user_phone_num, String user_name, String user_email, Response.Listener<String> listener) //리스너도 매개변수로
    {
